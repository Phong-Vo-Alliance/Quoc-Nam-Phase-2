...
export const TodoListManager: React.FC<{
  ...
  // Validate on blur only for new title
  ...
  // Validate on blur only for new description
  ...
  // Validate on blur only for edit title
  ...
  // Validate on blur only for edit description
  const handleEditDescriptionBlur = () => {
    const trimmed = editDescription.trim();
    setEditDescription(trimmed);
    const error = validateDescription(trimmed);
